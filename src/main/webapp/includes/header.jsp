...
<header class="flex p-6 items-center">
	<div class="flex items-center text-white justify-around w-full">
		...
		<a href="logged.do?action=logout" class="bg-red-700 py-4 px-4 hover:bg-red-500 font-bold rounded-lg">
			<button>Logout</button>
		</a>
		
		<% } else { %>
		
		<a href="disconnected.do?action=login_page" class="bg-[#0070FF] py-3 px-5 hover:bg-[#589EFA] font-bold rounded-lg">
			<button>Login</button>
		</a>
